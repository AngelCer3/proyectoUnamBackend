...
app.get("/appObtenerAcreditadosPorId/:id", (req, res) => {
  ...
  const query = "SELECT * FROM t_generales WHERE id_usuario = ?";
...
app.get("/appObtenerDatosEspecificosConyuge/:id", (req, res) => {
  ...
  conexion.query(query, [id_acreditado], (err, results) => {
    if (err) {
      ...
      res
        .status(500)
        .json({ error: "Error al obtener datos específicos cónyuge" });
    } else {
      if (results.length > 0) {
        res.json(results[0]);
      } else {
        res
          .status(404)
          .json({ error: "Datos específicos cónyuge no encontrados" });
      }
    }
  });
});
...
app.get("/appObtenerDatosOtrosFamiliares/:id", (req, res) => {
  ...
  conexion.query(query, [id_acreditado], (err, results) => {
    if (err) {
      ...
      res
        .status(500)
        .json({ error: "Error al obtener datos otros familiares" });
    } else {
      if (results.length > 0) {
        res.json(results[0]);
      } else {
        res
          .status(404)
          .json({ error: "Datos otros familiares no encontrados" });
      }
    }
  });
});
...
app.get("/appObtenerDatosEspecificosVivienda/:id", (req, res) => {
  ...
  conexion.query(query, [id_acreditado], (err, results) => {
    if (err) {
      ...
      res
        .status(500)
        .json({ error: "Error al obtener datos específicos vivienda" });
    } else {
      if (results.length > 0) {
        res.json(results[0]);
      } else {
        res
          .status(404)
          .json({ error: "Datos específicos vivienda no encontrados" });
      }
    }
  });
});
...
app.post("/appAgregarDatosReestructura", (req, res) => {
  const datosReestructura = {
    ...
    reestructura_solicitante_es_acred:
      req.body.reestructura_solicitante_es_acred,
    ...
    reestructura_institucion_dictamen:
      req.body.reestructura_institucion_dictamen,
    reestructura_fecha_dictamen: req.body.reestructura_fecha_dictamen,
    reestructura_porcentaje_discapacidad:
      req.body.reestructura_porcentaje_discapacidad,
...
app.post("/appAgregarDatosSolicitante", (req, res) => {
  const datosSolicitante = {
    ...
    solicitante_antiguedad_trabajo_anterior:
      req.body.solicitante_antiguedad_trabajo_anterior,
    ...
    institucion_cotizacion_solicitante:
      req.body.institucion_cotizacion_solicitante,
...
app.post("/appAgregarDatosEspecificosConyuge", (req, res) => {
  const datosEspecificosConyuge = {
    ...
    comprobante_ingreso_conyuge: req.body.comprobante_ingreso_conyuge,
...
app.post("/appAgregarDatosFamiliaDeudas", (req, res) => {
  const datosFamiliaDeudas = {
    ...
    familia_cantidad_deudas: req.body.familia_cantidad_deudas,
    id_acreditado: req.body.id_acreditado,
    id_usuario: req.body.id_usuario,
  };
...
app.post("/appAgregarDatosDocumentos", (req, res) => {
  const datosDocumentos = {
    ...
    doc_credencial_votar_entrego_copia:
      req.body.doc_credencial_votar_entrego_copia,
    ...
    doc_comprobante_ingresos_entrego_copia:
      req.body.doc_comprobante_ingresos_entrego_copia,
    id_acreditado: req.body.id_acreditado,
    id_usuario: req.body.id_usuario,
  };
...
app.put("/appActualizarDatosGenerales/:id", (req, res) => {
  ...
  conexion.query(query, [nuevosDatos, id_acreditado], (error, result) => {
    ...
    if (result.affectedRows === 0) {
      return res
        .status(404)
        .json({ success: false, message: "No se encontró el acreditado" });
    }
...
app.put("/appActualizarDatosEspecificosConyuge/:id", (req, res) => {
  ...
  conexion.query(query, [nuevosDatos, id_acreditado], (error, result) => {
    ...
    res.json({
      success: true,
      message: "Datos específicos del cónyuge actualizados",
    });
  });
});
...
app.put("/appActualizarDatosOtrosFamiliares/:id", (req, res) => {
  ...
  conexion.query(query, [nuevosDatos, id_acreditado], (error, result) => {
    ...
    res.json({
      success: true,
      message: "Datos de otros familiares actualizados",
    });
  });
});
...
app.put("/appActualizarDatosEspecificiosVivienda/:id", (req, res) => {
  ...
  conexion.query(query, [nuevosDatos, id_acreditado], (error, result) => {
    ...
    res.json({
      success: true,
      message: "Datos específicos de vivienda actualizados",
    });
  });
});
